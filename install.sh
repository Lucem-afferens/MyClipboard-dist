...
echo ""
echo "Что дальше:"
echo "  1. Menu Bar справа вверху — иконка MyClipboard (не в Dock; иногда за «›»)"
echo "  2. Системные настройки → Конфиденциальность → Универсальный доступ → вкл."
echo "  3. Скопируйте текст → ⌘⌥V → Enter"
echo ""
echo "Схема и подробности:"
echo "  https://github.com/${REPO}/blob/main/INSTALL.md"
